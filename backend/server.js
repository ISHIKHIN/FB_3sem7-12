...
async function initTestData() {
    ...
    products = [
        ...
        {
            id: String(nextProductId++),
            title: 'Кролик с длинными ушами',
            category: 'Зайцы',
            description: 'Серый зайка, 40 см',
            price: 456,
            inStock: true
        },
        {
            ...
            title: 'Котёнок',
            category: 'Кошки',
            description: 'Белый плюшевый котёноки, 25 см',
            price: 789,
            inStock: true
        },
        {
            ...
            title: 'Дракончикв',
            category: 'Дракончик',
            description: 'Зелёный дракон, 35 см.',
            price: 321,
            inStock: false
        },
        {
            id: String(nextProductId++),
            title: 'Обезьянка-балерина',
            category: 'Зверята',
            description: 'Обезьянка в юбке, 25 см',
            price: 654,
            inStock: true
        },
        {
            ...
            title: 'Собачка-батон',
            category: 'Собаки',
            description: 'Мягкая подушка-подголовник, 60 с',
            price: 987,
            inStock: true
        },
        {
            ...
            title: 'Единорог',
            category: 'Фэнтези',
            description: 'Белый единорог с цветной гривой, 35 см',
            price: 135,
            inStock: true
        },
        {
            ...
            title: 'Пингвинёнок',
            category: 'Птицы',
            description: 'Милый пингвин в шарфе, 20 см',
            price: 246,
            inStock: true
        }
    ];
...
initTestData().then(() => {
    app.listen(PORT, () => {
        ...
        console.log('Продавец: seller / seller123');
